						...
						<div class="col-md-8 col-lg-6 col-xl-5">
							...
							<div class="banner-text-inner">
								<div class="banner-shape-wrap">
									<div class="banner-shape-inner"> <img src="{pboot:sitedomain}/style/img/banner/shaps1.png" alt=""
											class='shape shape1 rotate3d'> <img src="{pboot:sitedomain}/style/img/banner/shaps2.png" alt=""
											class='shape shape2 rotate2d'> <img src="{pboot:sitedomain}/style/img/banner/shaps3.png" alt=""
											class='shape shape3 rotate-2d'> <img src="{pboot:sitedomain}/style/img/banner/shaps4.png" alt=""
											class='shape shape4 rotate3d'> <img src="{pboot:sitedomain}/style/img/banner/shaps5.png" alt=""
											class='shape shape5 rotate2d'> <img src="{pboot:sitedomain}/style/img/banner/shaps6.png" alt=""
											class='shape shape6 rotate-2d'> <img src="{pboot:sitedomain}/style/img/banner/shaps7.png" alt=""
											class='shape shape7 rotate3d'> </div>
								</div>
								...
								<a href="{label:down}" class="btn" target="_blank">免费注册</a> <a href="https://vip.okla.app/index.html"
									target="_blank" class="btn">平台登录</a>
							</div>
							<!-- banner text -->
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-7 col-sm-7">
						<!-- user interact image -->
						<div class="user-interact-image"> <img src="{pboot:sitedomain}/style/img/feature/01.png" alt="">
						</div>
					...
					<div class="col-lg-5 col-sm-5">
						...
						<div class="user-interact-inner">
							<div class="interact-icon"> <img src="{pboot:sitedomain}/style/img/icons/teamwork.svg" class="svg" alt="">
							</div>
							<h2>精准筛查助您轻松出海营销</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-sm-5">
						<!-- user ineract text -->
						<div class="user-interact-inner">
							<div class="interact-icon"> <img src="{pboot:sitedomain}/style/img/icons/solution1.svg" class="svg"
									alt=""> </div>
							<h2>直观界面一目了然</h2>
							<p> 快速高效响应你的诉求 </p>
							<a href="{label:down}" class="btn">Get Started</a>
					...
					<div class="col-lg-7 col-sm-7">
						<!-- user interact image -->
						<div class="user-interact-image type2"> <img src="{pboot:sitedomain}/style/img/feature/user-interact2.png"
								alt=""> </div>
						<!-- End of user interact image -->
					</div>
				</div>
		...
		<section class="app-video" style="display:none">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<!-- why bottle video -->
						<div class="theme-video-wrap"> <a href="{label:video}" class="video-btn" data-popup="video"><i
			...
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					...
					<div class="footer-widget">
						<div class="footer-logo"> <a href="{pboot:sitedomain}/"><img src="{pboot:sitelogo}" alt=""></a>
						</div>
						<p>{pboot:content id=31} [content:content drophtml=1 dropblank=1 len=40 more='']{/pboot:content}
						</p>
					</div>
					...
					<div class="footer-widget">
						<div class="widget-body">
							<div class="twetter-post-inner">
								<div class="footer-post-details" style="display:none"> <img src="{pboot:companyweixin}" width="175">
								</div>
							</div>
						</div>
					</div>
...
<script src="{pboot:sitedomain}/style/js/custom.js"></script>
  ...
  1 => '//LAPTOP-PIMM19LB/CMS/template/default/comm/foot.html',
); ?>