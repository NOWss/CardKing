    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="blog-list-inner"> 
          ...
          {pboot:search num=3 order=sorting  field='title|content'}
          <div class="single-blog-inner"> 
            <div class="post-image"> <a href="[search:link]"> <img src="[search:ico]" alt=""> </a>
              <div class="post-date">
                <p><span>[search:date style=m-d]</span>[search:date style=Y]</p>
              </div>
            </div>
            <div class="post-content">
              <div class="post-details">
                ...
                <p>[search:content drophtml=1 dropblank=1 len=50 mark=1]</p>
                <a class='btn' href="[search:link]">Read More</a> </div>
            </div>
          </div>
         {/pboot:search}
