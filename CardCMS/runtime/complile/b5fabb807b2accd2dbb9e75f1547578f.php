						...
						<div class="single-blog-box">
							<div class="single-blog-thumb">
								...
								<!-- <div class="blog-top-button">
									<a href="[search:link]"> <span>[search:date style=m-d] </span> [search:date style=Y] </a>
								</div> -->
							</div>
							<div class="em-blog-content">
								...
								<div class="em-blog-title">
									...
									<p style="margin-bottom: 50px;">[search:content drophtml=1 dropblank=1 len=50 mark=1]</p>
								</div>
...
<!--==================================================-->
  ...
  1 => '//LAPTOP-PIMM19LB/CMS/template/html/comm/right.html',
  2 => '//LAPTOP-PIMM19LB/CMS/template/html/comm/page.html',
  3 => '//LAPTOP-PIMM19LB/CMS/template/html/comm/foot.html',
); ?>