...
$(function () {
  ...
  $('.owl-dots').each(function () {
    var dotsText = ['Chatgpt付費', 'PayPal支付', '社交軟件增值功能/廣告投放購買', 'Apple ID', '跨境購物', '跨境服務器購買'];
  ...
  var $tabsItem = $('.tabs .tab-link'); // 截取字符串从 "?" 开始到第一个 "/" 结束，但不包含 "/" 
  ...
  $tabsItem.each(function (index, site) {
